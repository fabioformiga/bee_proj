<?php
    ...
    if($contents !== false){
        ...
        if ($conn->query($sql) === TRUE) {
            echo "New temperature created successfully at date " . $date . "<br />";
        } else {
        ...
        if ($conn->query($sql) === TRUE) {
            echo "New humidity created successfully at date " . $date . "<br />";
        } else {
            echo "Error: " . $sql . "<br>" . $conn->error;
        }
        ...
        if ($conn->query($sql) === TRUE) {
            echo "New weight created successfully at date " . $date . "<br />";
        } else {
            echo "Error: " . $sql . "<br>" . $conn->error;
        }
